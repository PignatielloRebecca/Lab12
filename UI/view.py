...
class View:
    ...
    def load_interface(self):
        ...
        self._pulsante_cammino_minimo=ft.ElevatedButton("Cammino Minimo", width=200,on_click=self.controller.handle_cammino_minimo if self.controller else None)
        row3=ft.Row([self._pulsante_cammino_minimo], alignment=ft.MainAxisAlignment.CENTER)
